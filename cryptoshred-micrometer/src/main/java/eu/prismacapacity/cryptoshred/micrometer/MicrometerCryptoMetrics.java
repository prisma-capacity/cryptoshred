...
public class MicrometerCryptoMetrics implements CryptoMetrics {
  ...
  @NonNull private final Counter missingKey;
  @NonNull private final Counter decryptionSuccess;
  @NonNull private final Counter decryptionFailure;
  @NonNull private final Counter keyLookUp;
  @NonNull private final Counter keyCreation;
  @NonNull private final Counter keyCreationAfterConflict;
